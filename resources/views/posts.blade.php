...
@section('container')
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card rounded-3">
                            <div class="position-absolute px-3 py-2 bg-opacity-25 rounded-end"
                                style="background-color: rgba(0, 0, 0, 0.568)"><a
    ...
    @else
        <p class="text-center fs-4">No post found, try search again</p>
    @endif
